...
<?php
if (checkRole(['partnership','company','single_owner_business','individual'])){
...
<!-- {{ Form::radio('user_type','seller', true, array('id'=>'seller', 'name'=>'user_type')) }} -->
    ...
    <!-- <label for="seller"> -->
    <!-- <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span> -->
    <!-- {{getPhrase('seller')}} -->
    <!-- </label> -->
<!-- </div> -->
<!-- <div class="col-md-4"> -->
...
<!-- </div>  -->
<div class="col-md-4">
{{ Form::radio('user_type','Individual', false, array('id'=>'Individual', 'name'=>'user_type')) }}
    <label for="Individual"> <!-- <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span>--> {{getPhrase('Individual')}} 
    </label>
</div>
<div class="col-md-4">
{{ Form::radio('user_type','Partnership', false, array('id'=>'Partnership', 'name'=>'user_type')) }}
    <label for="Partnership"> <!-- <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span>--> {{getPhrase('Partnership')}} 
    </label>
</div>
<div class="col-md-4">
{{ Form::radio('user_type','Company', false, array('id'=>'Company', 'name'=>'user_type')) }}
    <label for="Company"> <!-- <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span> --> {{getPhrase('Company')}} 
    </label>
</div>
<div class="col-md-4">
{{ Form::radio('user_type','Single-Owner-Business', false, array('id'=>'Single-Owner-Business', 'name'=>'user_type')) }}
    <label for="Single-Owner-Business">  <!--<span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span> --> {{getPhrase('Single Owner Business')}} 
    </label>
</div>
</div>
...
{{ Form::text('org_name', old('org_name') , $attributes = array('class'=>'form-control org_name',

'placeholder' => 'Orgranaization Name',

'ng-model'=>'org_name',

'ng-class'=>'{"has-error": registrationForm.org_name.$touched && registrationForm.org_name.$invalid}',
...
<div class="validation-error" ng-messages="registrationForm.org_name.$error" >
...
<div class="form-group col-lg-10" style="margin-left:20px">
                           ...
                           {{ Form::checkbox('ta') }}
                           {!! Form::label('ta', getPhrase('Agreed Terms and Conditions'), ['class' => 'control-label']) !!}
...
$( document ).ready(function() {
    ...
    $('input[type=radio][name=user_type]').change(function() {
        ...
        console.log('organaization field is here');
