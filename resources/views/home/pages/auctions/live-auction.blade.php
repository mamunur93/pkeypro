...
<style>
    #latest_bids > .list-group > li:nth-child(1) {
    background: green;
    font-size: 24px;
    color: #fff;
}

#latest_bids > .list-group > li:nth-child(2) {
    background: #00800063;
    color: #000;
    font-size: 20px;
}

#latest_bids > .list-group > li:nth-child(3) {
    background: #ffec099c;
    color: #000;
    font-size: 16px;
}

#latest_bids > .list-group > li {
    background: #ff000094;
    color: #fff;
}
</style>
...
<div class="row">
	...
	<div class="col-md-6 bid-data">
		...
		<div class="form-group bid-form-group">
			...
			<p>Reserve Price {{$currency_code}}{{$auction->reserve_price}}</p>
			<p>Ends on {{$live_auction_date}} {{$auction->live_auction_end_time}}</p>
			<h1 style="font-size:50px;font-weight:700;border: 2px solid #ddd;padding: 10px;text-align: center;margin-bottom: 52px;margin-top: 56px;background: radial-gradient(#fff, #bbb);" id="demo"></h1>
		...
		<div class="col-md-6">
			<div id="latest_bids">
			    <h2 class="text-center bg-primary" style="padding: 10px;border-radius: 23px;">Current Positions <br> <i class="glyphicon glyphicon-arrow-down"></i></h2>
