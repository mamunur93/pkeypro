...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            @can('employee_access')
            <li class="{{ isActive($active_class,'employee_management')}}">
            ...
            <li class="{{ isActive($active_class,'permission_management')}}">
            ...
            @can('role_access')
            <li class="{{ isActive($active_class,'roles_management')}}">
                <a href="{{ URL_ROLES }}">
                    <i class="fa fa-tasks"></i>
                    <span>{{getPhrase('roles_management')}}</span>
                </a>
            </li>
            @endcan
            ...
            <li class="{{ isActive($active_class,'industry_type')}}">
            ...
            <li class="{{ isActive($active_class,'payments')}}">
                <a href="{{ URL_PAYMENT_HISTORY }}">
                    ...
                    <span>{{getPhrase('Payments Details')}}</span>
                </a>
            </li>
            @endif
