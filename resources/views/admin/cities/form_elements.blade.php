			...
			<div class="col-xs-6"> 	
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('post_office', getPhrase('post office'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('post_office', old('post_office'), $attributes = 
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('post_code', getPhrase('post Code'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('post_code', old('post_code'), $attributes = 
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('police_station', getPhrase('Police Station'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('police_station', old('police_station'), $attributes = 
