            ...
            <table class="table table-bordered table-striped datatable">
                <thead>
                    <tr>
                        ...
                        <th> {{getPhrase('post office')}} </th>
                        <th> {{getPhrase('post code')}} </th>
                        <th> {{getPhrase('police station')}} </th>
                        ...
                        @foreach ($cities as $city)
                         <?php $i++;?>
                            <tr data-entry-id="{{ $city->id }}">
                                ...
                                <td field-key='state'> {{$city->post_office}} </td>
                                <td field-key='state'> {{$city->post_code}} </td>
                                <td field-key='state'> {{$city->police_station}} </td>
