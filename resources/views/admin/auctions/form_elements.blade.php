...
<div class="col-xs-12">
			...
			<div class="col-xs-6"> 	
				...
				<div class="form-group">
                    ...
                    {!! Form::label('bidininame', getPhrase('Bid Initiator Name'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('bidininame', old('bidininame'), $attributes = 
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('currency', getPhrase('Currency'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('currency', old('currency'), $attributes = 
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('title', getPhrase('Bid Event Title'), ['class' => 'control-label']) !!}
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    {!! Form::label('bit_event_category', getPhrase('Bit Event Category'), ['class' => 'control-label']) !!}
                    ...
                    {{Form::select('bit_event_category', ["1"=> "Open", "2"=> "Close"] , $selected, ['placeholder' => getPhrase('select'),'class'=>'form-control select2',
                ...
                <div class="form-group istiyak-close">

                        <label for="name"> {{ getPhrase('Select Participants') }} <span class="text-red">*</span></label>
                        ...
                        {{Form::select('close_users[]', $users, null, ['class'=>'form-control select2',
                ...
                <div class="form-group">
                    ...
                    <div class="form-group row">
                        ...
                        {{ Form::radio('is_bid_increment', 0, false, array('id'=>'bid_increment_no', 'name'=>'is_bid_increment')) }}
                            ...
                            <label for="bid_increment_no"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span> {{getPhrase('Reverse Auction')}}</label> 
                        </div>
                        <div class="col-md-6">
                        {{ Form::radio('is_bid_increment', 1, true, array('id'=>'bid_increment_yes', 'name'=>'is_bid_increment')) }}
                            <label for="bid_increment_yes"> <span class="fa-stack radio-button"> <i class="mdi mdi-check active"></i> </span> {{getPhrase('English')}} 
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('description', getPhrase('specification'), ['class' => 'control-label']) !!}
                ...
                <div class="form-group">
                     ...
                     {!! Form::label('file', getPhrase('file'), ['class' => 'control-label']) !!}

                    <div class="row"> 

                       <div class="col-md-6">

                        {!! Form::file('file', array('id'=>'file_input', 'accept'=>'.pdf,.doc,.docx')) !!}
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="{{ getAuctionImage($record->file,'auction') }}"> Download File </a>
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('line_item1', getPhrase('Line Item 1'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('line_item1', old('line_item1'), $attributes = 
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('line_item2', getPhrase('Line Item 2'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('line_item2', old('line_item2'), $attributes = 
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('line_item3', getPhrase('Line Item 3'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('line_item3', old('line_item3'), $attributes = 
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('line_item4', getPhrase('Line Item 4'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('line_item4', old('line_item4'), $attributes = 
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('line_item5', getPhrase('Line Item 5'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('line_item5', old('line_item5'), $attributes = 
            ...
            <div class="col-xs-6">  
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('quantity', getPhrase('quantity'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('quantity', old('quantity'), $attributes = 
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('unit_of_measurement', getPhrase('Unit of Measurement'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('unit_of_measurement', old('unit_of_measurement'), $attributes = 
                 ...
                 <div class="form-group">
                    ...
                    {!! Form::label('unit_price', getPhrase('Unit Price'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('unit_price', old('unit_price'), $attributes = 
                 ...
                 <div class="form-group">
                    ...
                    {!! Form::label('total_price', getPhrase('Total Price'), ['class' => 'control-label']) !!}
                    ...
                    {{ Form::text('total_price', old('total_price'), $attributes = 
