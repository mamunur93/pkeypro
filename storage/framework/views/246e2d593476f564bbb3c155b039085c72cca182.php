...
<?php echo e(Form::text('phone', $value = null , $attributes = array('class'=>'form-control',
...
<?php echo e(Form::text('org_name', old('org_name') , $attributes = array('class'=>'form-control org_name',
...
<div class="form-group col-lg-10" style="margin-left:20px">
                           ...
                           <?php echo e(Form::checkbox('ta')); ?>

                           <?php echo Form::label('ta', getPhrase('Agreed Terms and Conditions'), ['class' => 'control-label']); ?>
