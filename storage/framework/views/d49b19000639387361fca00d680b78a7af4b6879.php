...
<div class="col-xs-12">
			...
			<div class="col-xs-6"> 	
                ...
                <div class="form-group istiyak-close">
                        ...
                        <label for="name"> <?php echo e(getPhrase('Select Participants')); ?> <span class="text-red">*</span></label>
                ...
                <div class="form-group">
                     ...
                     <?php echo Form::label('file', getPhrase('file'), ['class' => 'control-label']); ?>
                    ...
                    <div class="row"> 
                       ...
                       <div class="col-md-6">
                        ...
                        <?php echo Form::file('file', array('id'=>'file_input', 'accept'=>'.pdf,.doc,.docx')); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="<?php echo e(getAuctionImage($record->file,'auction')); ?>"> Download File </a>
