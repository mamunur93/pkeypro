...
<?php $__env->startSection('content'); ?>
    <div class="container" style="margin-top: 41px;margin-left: 500px;">
     ...
     <div class="panel panel-default">
        ...
        <div class="panel-body form-auth-style" id="app">
        	...
        	<div class="row">
				...
				<?php else: ?>
				<?php echo Form::open(array('url' => '/employees/create', 'method' => 'POST','name'=>'formValidate', 'files'=>'true', 'novalidate'=>'')); ?>

				<?php endif; ?>

				<?php echo $__env->make('admin.employees.form_elements', array('record' => $record), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
