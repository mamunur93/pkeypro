...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="<?php echo e(isActive($active_class,'employee_management')); ?>">
            ...
            <li class="<?php echo e(isActive($active_class,'permission_management')); ?>">
            ...
            <li class="<?php echo e(isActive($active_class,'roles_management')); ?>">
                <a href="<?php echo e(URL_ROLES); ?>">
                    <i class="fa fa-tasks"></i>
                    <span><?php echo e(getPhrase('roles_management')); ?></span>
                </a>
            </li>
            <?php endif; ?>
            ...
            <li class="<?php echo e(isActive($active_class,'industry_type')); ?>">
                <a href="/admin/industry-type">
            ...
            <li class="<?php echo e(isActive($active_class,'payments')); ?>">
                <a href="<?php echo e(URL_PAYMENT_HISTORY); ?>">
                    ...
                    <span><?php echo e(getPhrase('Payments Details')); ?></span>
                </a>
            </li>
            <?php endif; ?>
