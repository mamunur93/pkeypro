                ...
                <!--Dashboard-->
                  ...
                  <li class="<?php echo e(bidderActive($active_class,'user_management')); ?>">
                    ...
                    <ul class="submenu">
                      ...
                      <li class="<?php echo e($request->segment(2) == 'business' ? 'active active-sub' : ''); ?>"><a href="<?php echo e(URL_BUSINESS_EDIT); ?>/<?php echo e($user->slug); ?>" title="Business"><?php echo e(getPhrase('Business Details')); ?></a></li>

                      <li class="<?php echo e($request->segment(2) == 'org' ? 'active active-sub' : ''); ?>"><a href="<?php echo e(URL_ORG_EDIT); ?>/<?php echo e($user->slug); ?>" title="Org"><?php echo e(getPhrase('Organization Details')); ?></a></li>

                      <li class="<?php echo e($request->segment(2) == 'bank' ? 'active active-sub' : ''); ?>"><a href="<?php echo e(URL_BANK_EDIT); ?>/<?php echo e($user->slug); ?>" title="Bank"><?php echo e(getPhrase('Bank Details')); ?></a></li>

                      <li class="<?php echo e($request->segment(2) == 'certificate' ? 'active active-sub' : ''); ?>"><a href="<?php echo e(URL_CERTIFICATE_EDIT); ?>/<?php echo e($user->slug); ?>" title="Certificate"><?php echo e(getPhrase('Certificates and & Membership')); ?></a></li>
  
                    <?php if($user->role_id !=4 ): ?>
                    <li class="<?php echo e($request->segment(2) == 'slave' ? 'active active-sub' : ''); ?>"><a href="<?php echo e(URL_SLAVE_EDIT); ?>/<?php echo e($user->slug); ?>" title="Org"><?php echo e(getPhrase('Slave USers')); ?></a></li>
                    <?php endif; ?>
                  ...
                  <li class="<?php echo e(bidderActive($active_class,'auctions')); ?>">
                    ...
                    <ul class="submenu">
                      ...
                      <!-- <li class="<?php echo e($request->segment(2) == 'create-auctions' ? 'active active-sub' : ''); ?>"><a href="<?php echo e(URL_LIST_AUCTIONS); ?>" title="Create Auctions">  <?php echo e(getPhrase('create auctions')); ?>  </a></li> -->
