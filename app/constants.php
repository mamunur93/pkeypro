...
define('URL_BUSINESS_EDIT', PREFIX.'users/business/edit');
define('URL_ORG_EDIT', PREFIX.'users/org/edit');
define('URL_SLAVE_EDIT', PREFIX.'users/slave');
define('URL_BANK_EDIT', PREFIX.'users/bank/edit');
define('URL_CERTIFICATE_EDIT', PREFIX.'users/certificate/edit');
...
// INDUSTRY TYPE
define('URL_INDUSTRY_TYPE_ADD', PREFIX.'admin/industry-type/create');
define('URL_INDUSTRY_TYPE_VIEW', PREFIX.'admin/industry-type/view');
define('URL_INDUSTRY_TYPE_DELETE', PREFIX.'admin/industry-type/delete');
