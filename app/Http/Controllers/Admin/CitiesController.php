...
class CitiesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
         ...
         'post_office'         => 'bail|required|max:100',
         'post_code'         => 'bail|required|max:100',
         'police_station'         => 'bail|required|max:100',
        ...
        $record->city            = $city;
        $record->post_office            = $post_office;
        $record->post_code            = $post_code;
        $record->police_station            = $police_station;
