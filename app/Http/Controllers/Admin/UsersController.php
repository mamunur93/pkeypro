...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = User::join('roles', 'users.role_id', '=', 'roles.id')
                  ->select(['users.id','users.username','users.email','users.image','roles.display_name','users.slug','users.role_id','users.business_telephone','users.approved'])
...
//Mamunur Rahaman
    ...
    public function org($slug)
    {
        ...
        $slave_users = User::join('roles', 'users.role_id', '=', 'roles.id')
    ...
    public function slave($slug)
    {
        ...
        $slave_users = User::join('roles', 'users.role_id', '=', 'roles.id')
                  ->select(['users.id','users.name','users.email','users.image','roles.display_name','users.slug','users.role_id','users.phone','users.approved'])
                  ->where('parent_user_id', auth::user()->id)
                  ->orderBy('users.updated_at', 'desc')->get();
