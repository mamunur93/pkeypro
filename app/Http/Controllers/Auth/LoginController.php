    ...
    */
    ...
    public function index()
    {
      ...
      if (isset($user) && $user->role_id!=getRoleData('bidder'))
       //$user->role_id!=getRoleData('individual') || $user->role_id!=getRoleData('partnership') || $user->role_id!=getRoleData('company') || $user->role_id!=getRoleData('single_owner_business') 
