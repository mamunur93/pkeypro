...
Route::group(['middleware' => ['auth', 'approved'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    //industry type
    Route::get('industry-type/view/{slug}', 'Admin\IndustryTypeController@show');
    Route::resource('industry-type', 'Admin\IndustryTypeController');

    Route::post('industry-type/create', 'Admin\IndustryTypeController@store');
    Route::delete('industry-type/delete/{id}', 'Admin\IndustryTypeController@massDestroy');

    Route::post('industry-type_mass_destroy', ['uses' => 'Admin\IndustryTypeController@massDestroy', 'as' => 'industry_type.mass_destroy']);
    Route::post('industry-type_restore/{id}', ['uses' => 'Admin\IndustryTypeController@restore', 'as' => 'industry_type.restore']);
    Route::delete('industry-type_perma_del/{id}', ['uses' => 'Admin\IndustryTypeController@perma_del', 'as' => 'industry_type.perma_del']);
    //industry type
    ...
    Route::get('language/{lang}', function ($lang) {
      ...
      //PERMISSIONS ROUTES
    Route::get('permissions', 'Admin\PermissionsController@index')->name('admin.permissions.index');  
    ...
    Route::post('employees_mass_destroy', ['uses' => 'Admin\EmployeeController@massDestroy', 'as' => 'employees.mass_destroy']);
    Route::resource('user_actions', 'Admin\UserActionsController');

    Route::post('employees/create','Admin\EmployeeController@store');
    Route::patch('employees/edit/{slug}','Admin\EmployeeController@update');
    Route::get('employees/edit/{slug}', 'Admin\EmployeeController@edit');

  

    // Mamunur Rahaman
    Route::get('users/business/edit/{slug}', 'Admin\UsersController@business')->name('user.business');
    Route::patch('users/business/edit/{slug}','Admin\UsersController@business_update');
    Route::get('users/org/edit/{slug}', 'Admin\UsersController@org')->name('user.business');
    Route::get('users/slave/{slug}','Admin\UsersController@slave');
    Route::get('users/bank/edit/{slug}', 'Admin\UsersController@bank')->name('user.bank');
    Route::get('users/certificate/edit/{slug}', 'Admin\UsersController@business')->name('user.certificate');
    ...
    // START CODED BY ISTIYAK
    Route::post('auctions/get-event-categories', 'AuctionsController@getEventCategories');
    // END CODED BY ISTIYAK
